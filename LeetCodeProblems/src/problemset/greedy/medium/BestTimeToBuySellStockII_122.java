...
public class BestTimeToBuySellStockII_122 {
    public static void main(String[] args) {
        ...
        int arr[] = {7,1,5,3,6,4};
        BestTimeToBuySellStockII_122 obj = new BestTimeToBuySellStockII_122();
    ...
    public int maxProfit(int[] prices) {
        if(prices == null || prices.length == 0)
            return 0;
        //index i represent day
        //prices[i] represent stock price on given day
        //pick stock only if profit possible
        // in case no profit possible, don't buy stock, return 0
        int profit = 0;
